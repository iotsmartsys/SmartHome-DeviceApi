...
| Estado composto do ar | `SHD-AIR-CONDITIONER-STATE-001@0.1` | Draft | JSON textual em Value; análise não pronta por decisões funcionais pendentes; implementação não iniciada |

...
| Groups | `SHD-GROUPS-MAINTENANCE-SUPPORT-001@0.1` e código | Mapped | Contrato administrativo implementado; mantém relações com capabilities; validação MySQL pendente |
